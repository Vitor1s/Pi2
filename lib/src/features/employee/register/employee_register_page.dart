...
import 'package:pi2/src/core/ui/widgets/avatar_widget.dart';
...
import 'package:pi2/src/features/employee/register/employee_register_vm.dart';
...
class _EmployeeRegisterPageState extends ConsumerState<EmployeeRegisterPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final barbeariapiAsyncValue = ref.watch(getMyBarbeariapiProvider);
    ...
    return Scaffold(
      ...
      body: barbeariapiAsyncValue.when(
        ...
        data: (barbeariapi) {
          final BarbeariapiModel(:openDays, :openHours) = barbeariapi;
