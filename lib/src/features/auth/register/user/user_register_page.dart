...
import 'package:pi2/src/features/auth/register/user/user_register_vm.dart';
  ...
  Widget build(BuildContext context) {
    ...
    ref.listen(
      ...
      (_, state) => switch (state) {
        ...
        UserRegisterStateStatus.success => Navigator.of(
          context,
        ).pushNamed('/auth/register/barbeariapi'),
        UserRegisterStateStatus.error => context.showError(
